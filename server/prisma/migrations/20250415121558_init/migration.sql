...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_assigneUserId_fkey" FOREIGN KEY ("assigneUserId") REFERENCES "User"("userId") ON DELETE SET NULL ON UPDATE CASCADE;
